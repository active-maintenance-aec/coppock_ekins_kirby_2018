# coppock_ekins_kirby_2018/download_original.R
...
#   against. md5_published is the checksum Dataverse displays. Here all twenty agree,
#   including the two data files Dataverse ingested to tabular `.tab`, whose published
#   checksums describe the deposited RData rather than the derived table. They do not
#   always agree: other deposits in this program carry published checksums that verify
#   neither the original nor the derived file, so verification runs against md5_served
...
dataset_doi <- "doi:10.7910/DVN/3KBCJF"
